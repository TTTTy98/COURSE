    ...
    <el-row>
      ...
      <el-col :span="12">
        ...
        >
          <el-radio-group
            :disable="readOnly"
            v-model="ruleForm.offshoreStudent"
          >
      ...
      <el-col :span="12">
        <el-text class="mx-1" type="info" style="margin-left: 20px"
          >Upload CV(PDF only)</el-text
        >
        <uploadCourseFile />
      </el-col>
      <el-col :span="12">
        <el-text class="mx-1" type="info" style="margin-left: 20px"
          >Academic Transcript upload（ PDF only）</el-text
        >
        <uploadCourseFile />
      </el-col>
      <el-col :span="12">
        <el-form-item
          label="Your grade when taken"
          label-width="200"
          prop="grade"
        >
          <div class="grade-list-box">
            <gradeList @chooseGrade="chooseGrade" />
          </div>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        ...
        >
          ...
          <el-input
            type="textarea"
            :disable="readOnly"
            v-model="ruleForm.previousExperience"
          />
        </el-form-item>
      </el-col>
      <el-col :span="12">
